...
// RecoverCacheFile creates wrapper struct around a cache file on disk
// dir is a directory on whose file system the file will live,
// or the system default temporary location if empty.
// TODO ezl we should refactor reading/writing cache files and metadata to a different package
func RecoverCacheFile(
	...
	if err != nil {
		return nil, fmt.Errorf("could not retrieve file stats: %w", err)
	}
